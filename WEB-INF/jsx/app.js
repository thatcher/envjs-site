 ...
 */
    ...
    <head profile="http://a9.com/-/spec/opensearch/1.1/">
		 ...
		 */ 
		 -->
        <script src="./app/models/docs.js"               type="text/envjs" ></script>
        ...
        <script src="./app/views/docs.js"                type="text/envjs" ></script>
        <script src="./app/views/support.js"             type="text/envjs" ></script>
        ...
        <script src="./app/services/docs.js"             type="text/envjs" ></script>
        <script src="./app/services/support.js"          type="text/envjs" ></script>
