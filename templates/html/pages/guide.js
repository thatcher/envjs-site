    ...
    <block id='main'>
        <div id='doc'>
            ...
            <div class=' column span-4 colborder'>
                <h4>running</h4>
                <ul>
                {_('.*',_$.doc.running).map(function(index, value){
                    return {
                ...
                <h4>walking</h4>
                <ul>
                {_('.*',_$.doc.walking).map(function(index, value){
                    return {
                        li: {a:{$href:'#'+this.name, $:this.name}}
                    };
                }).e4x()}
                ...
                <h4>crawling</h4>
                <ul>
                {_('.*',_$.doc.crawling).map(function(index, value){
                    return {
                        li: {a:{$href:'#'+this.name, $:this.name}}
                    };
                }).e4x()}
            ...
            <div class='first column span-13'>
			    ...
			    <p>
			       See the <a href={$.env('root')+'api-'+_$.doc.version}>API</a>
